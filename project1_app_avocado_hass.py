...
if choice == 'Introduction':
    ...
    st.write("**According to some researchs, there is a key market trend: Increasing Awareness Regarding the Health Benefits of Hass Avocado.**")
...
# 2. Summary about Projects
    ...
    st.write("<h3 style='text-align: left; color: Black; font-size:20px'>Data Preparation</h3>", unsafe_allow_html=True)
    ...
    st.write("With normal dataset:")
    st.dataframe(pd.read_csv('model/Problem1_compare_models_Lazy_1.csv'))
    st.write("With scaled dataset:")
    st.dataframe(pd.read_csv('model/Problem1_compare_models_Lazy_2.csv'))
