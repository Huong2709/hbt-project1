...
# 2. Summary about Projects
    ...
    st.image('material/EDA_displot.PNG')
    ...
    st.image('material/EDA_price_by_type.PNG')

    st.write("<h6 style='text-align: left; color: Black; font-size:15px'>AveragePrice by date:</h6>", unsafe_allow_html=True)
    st.image('material/EDA_price_by_date.PNG')

    st.write("<h6 style='text-align: left; color: Black; font-size:15px'>AveragePrice by region:</h6>", unsafe_allow_html=True)
    st.image('material/EDA_price_by_region.PNG')

    st.write("<h1 style='text-align: left; color: Black; font-size:20px'>Objective 1: Using Regression Algorithms to predict AveragePrice</h1>", unsafe_allow_html=True)
    ...
    st.image('material/P1_ExtraTree_train.PNG')
    st.write("Evaluation visualization - test dataset")
    st.image('material/P1_ExtraTree_test.PNG')
    ...
    st.write("<h1 style='text-align: left; color: Black; font-size:20px'>Objective 2: Using Time Series Algorithms to forecast AveragePrice of specific type of avocado and region.</h1>", unsafe_allow_html=True)
